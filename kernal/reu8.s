...
L5021:  asl     $8D                             ; 5021 06 8D                    ..
        ...
        pha                                     ; 503F 48                       H
        bvc     L5042                           ; 5040 50 00                    P.
L5042:  adc     $06EB,y                         ; 5042 79 EB 06                 y..
        jmp     L7900                           ; 5045 4C 00 79                 L.y
...
; ----------------------------------------------------------------------------
        brk                                     ; 5308 00                       .
        bpl     L530B                           ; 5309 10 00                    ..
L530B:  iny                                     ; 530B C8                       .
        brk                                     ; 530C 00                       .
        rol     $00,x                           ; 530D 36 00                    6.
...
L5400:  sta     $8000,y                         ; 5400 99 00 80                 ...
        iny                                     ; 5403 C8                       .
...
; ----------------------------------------------------------------------------
        ...
        lda     #$00                            ; 542F A9 00                    ..
        ldy     #$33                            ; 5431 A0 33                    .3
L5433:  sta     $8000,y                         ; 5433 99 00 80                 ...
        iny                                     ; 5436 C8                       .
        cpy     #$36                            ; 5437 C0 36                    .6
...
; ----------------------------------------------------------------------------
L543C:  sta     $8000,y                         ; 543C 99 00 80                 ...
        pha                                     ; 543F 48                       H
        tya                                     ; 5440 98                       .
        clc                                     ; 5441 18                       .
        adc     #$03                            ; 5442 69 03                    i.
